...
constexpr const char* PYROMANCER_ABILITY_DESCRIPTION =
	"Thrice a turn, you may discard the top card of each player's deck."
;
...
constexpr int PYROMANCER_ABILITY_USES = 3;
...
constexpr const char* CLERIC_ABILITY_DESCRIPTION =
	"At the end of each turn, heal 50 damage from each of your fighters."
;
...
constexpr int VACUUMANCER_HEALTH = 1300;
...
constexpr const char* VACUUMANCER_ATTACK_DESCRIPTION =
	...
	"Deal 500 to your opponent's active fighter."
;
constexpr const char* VACUUMANCER_ATTACK_EFFECTS = GUST_EFFECT; // gust
constexpr int VACUUMANCER_ATTACK_DAMAGE = 500;
...
constexpr const char* SMUGGLER_DESCRIPTION =
	"Shuffle a card from your trash into your deck."
;
