...
constexpr int PLAYER_EXPLANATION_COUNT = 17;
...
#define PLAYER_EFFECT_CONDITIONS(X) (                                 \
	...
	: X == 3 ? static_cast<bool>(ATTACKED_CONDITION)                  \
	: X == 4 ? static_cast<bool>(RETREATED_CONDITION)                 \
	: X == 5 ? static_cast<bool>(FORBIDDEN_FUEL_CONDITION)            \
	: X == 6 ? static_cast<bool>(BOOST_CONDITION)                     \
	: X == 7 ? static_cast<bool>(BANISHMENT_CONDITION)                \
	: X == 8 ? static_cast<bool>(FREEDOM_CONDITION)                   \
	: X == 9 ? static_cast<bool>(AGILITY_AURA_CONDITION)              \
	: X == 10 ? static_cast<bool>(HEAL_AURA_CONDITION)                \
	: X == 11 ? static_cast<bool>(PLAYER_POWER_CONDITION)             \
	: X == 12 ? static_cast<bool>(END_DRAW_CONDITION)                 \
	: X == 13 ? static_cast<bool>(EXPERIMENTER_END_DISCARD_CONDITION) \
	: X == 14 ? static_cast<bool>(BANKER_END_DISCARD_CONDITION)       \
	: X == 15 ? static_cast<bool>(GATEKEEPER_END_DISCARD_CONDITION)   \
...
#define PLAYER_EFFECT_VALUES(X) (              \
	...
	: X == 3 ? ATTACKED_VALUE                  \
	: X == 4 ? RETREATED_VALUE                 \
	: X == 5 ? FORBIDDEN_FUEL_VALUE            \
	: X == 6 ? BOOST_VALUE                     \
	: X == 7 ? BANISHMENT_VALUE                \
	: X == 8 ? FREEDOM_VALUE                   \
	: X == 9 ? AGILITY_AURA_VALUE              \
	: X == 10 ? HEAL_AURA_VALUE                \
	: X == 11 ? PLAYER_POWER_VALUE             \
	: X == 12 ? END_DRAW_VALUE                 \
	: X == 13 ? EXPERIMENTER_END_DISCARD_VALUE \
	: X == 14 ? BANKER_END_DISCARD_VALUE       \
	: X == 15 ? GATEKEEPER_END_DISCARD_VALUE   \
...
#define PLAYER_EFFECT_EXPLANATIONS(X) (    \
	...
	: X == 3 ? ATTACKED_EXPLANATION        \
	: X == 4 ? RETREATED_EXPLANATION       \
	: X == 5 ? FORBIDDEN_FUEL_EXPLANATION  \
	: X == 6 ? BOOST_EXPLANATION           \
	: X == 7 ? BANISHMENT_EXPLANATION      \
	: X == 8 ? FREEDOM_EXPLANATION         \
	: X == 9 ? AGILITY_AURA_EXPLANATION    \
	: X == 10 ? HEAL_AURA_EXPLANATION      \
	: X == 11 ? PLAYER_POWER_EXPLANATION   \
	: X == 12 ? END_DRAW_EXPLANATION       \
	: X == 13 ? END_DISCARD_EXPLANATION    \
	: X == 14 ? END_DISCARD_EXPLANATION    \
...
constexpr const char* ARMS_SMUGGLER_DESCRIPTION =
	"Attacks deal 50 more damage this turn.\n"
	"Shuffle this card into your deck instead of discarding it.\n"
...
constexpr int SUPPORTER_COUNT = 36;
...
/* CHANGELOG:
	 ...
	 v1.2:
	   ...
	   Magic Missiles' cost was decreased from 1000 to 2000.
