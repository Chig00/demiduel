...
constexpr int NINJA_HEALTH = 1300;
...
constexpr const char* NINJA_ATTACK_DESCRIPTION =
	"Flip 3 coins.\n"
	"For each heads, deal 350 damage to one of your opponent's fighters for each heads."
;
...
constexpr int SAMURAI_ATTACK_DAMAGE = 500;
