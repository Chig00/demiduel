...
constexpr int PLAYER_EXPLANATION_COUNT = 15;
...
#define PLAYER_EFFECT_CONDITIONS(X) (                                 \
	...
	: X == 13 ? static_cast<bool>(BANKER_END_DISCARD_CONDITION)       \
...
#define PLAYER_EFFECT_EXPLANATIONS(X) (              \
	...
	: X == 12 ? END_DISCARD_EXPLANATION              \
	: X == 13 ? END_DISCARD_EXPLANATION              \
...
constexpr int PYROMANCER_HEALTH = 1400;
...
constexpr const char* PYROMANCER_ABILITY_DESCRIPTION =
	"Once a turn, you may discard the top 4 cards of each player's deck."
;
...
constexpr int CULTIST_ATTACK_COST = 1000;
//}
//}
...
const DeckCode VOID_DECK(
	...
	"Vacuumancer is a fighter that can be banished, so Cultist can use its attack.",
	{
		// Fighter Cards
		0, // DRIVER
		0, // RACER
